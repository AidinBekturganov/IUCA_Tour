...
class MenuController: UIViewController {
    ...
    private let finishTourButton: UIButton = {
        ...
        label.text = "ЗАВЕРШИТЬ ЭКСКУРСИЮ"
        label.font = .systemFont(ofSize: 17)
        label.textColor = .white
        
        imageView.image = #imageLiteral(resourceName: "Vector-3")
        
        button.backgroundColor = UIColor.rgb(red: 201, green: 80, blue: 56)
...
//        dismiss(animated: true, completion: nil)
    ...
    func configureTableViewForListOfStops() {
        ...
        placesCollectionView.anchor(top: labelList.bottomAnchor, left: view.leftAnchor, bottom: finishTourButton.topAnchor, right: view.rightAnchor, paddingTop: 25, paddingBottom: 5)
    }
